...
public class Test : MonoBehaviour {
    private void OnEnable() {
        USNLCallbackEvents.OnConnected += OnConnected;
    ...
    private void OnConnected(object _object) {
        ...
        PacketSend.VariablesTest(varByte, varShort, varInt, varLong, varFloat, varBool, varString, varVec2, varVec3, varQuat, varArrayByte, varArrayShort, varArrayInt, varArrayLong, varArrayFloat, varArrayBool, varArrayString, varArrayVec2, varArrayVec3, varArrayQuat);
