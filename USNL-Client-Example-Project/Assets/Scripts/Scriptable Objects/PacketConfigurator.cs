...
public class PacketConfigurator : ScriptableObject {
    ...
    private ServerPacketConfig[] libServerPackets = {
        new ServerPacketConfig(
            "Welcome",
            new PacketVariable[] { new PacketVariable("Welcome Message", PacketVarTypes.String), new PacketVariable("Welcome Message", PacketVarTypes.String), new PacketVariable("Client Id", PacketVarTypes.Int) },
    ...
    public ServerPacketConfig[] LibServerPackets { get => libServerPackets; set => libServerPackets = value; }
